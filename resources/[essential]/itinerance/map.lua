local blips = {
  ...
  {name="Depanneur", colour=10, scale=0.9, id=68, x=473.072845458984, y=-1309.66833496094, z=29.2292041778564},
   -- Airport and Airfield
   {name="Aéroport", colour=15, scale=0.8, id=90, x=-1032.690, y=-2728.141, z=13.757},
   {name="Aéroport", colour=15, scale=0.8, id=90, x=1743.6820, y=3286.2510, z=40.087},
   -- barbers
   {name="Coiffeur", colour=5, scale=0.8, id=71, x = 1933.6905517578, y = 3730.6245117188, z = 32.854434967041},
   {name="Coiffeur", colour=5, scale=0.8, id=71, x = 1211.2866210938, y = -474.07333374023, z = 66.218040466309},
   {name="Coiffeur", colour=5, scale=0.8, id=71, x = -814.66107177734, y = -184.29020690918, z = 37.568893432617},
   ...
   {name="Magasin", colour=0, scale=0.9, id=52, ['x'] = 1165.8406982422, ['y'] = 2707.2707519531, ['z'] = 38.157707214355},
    -- Clothing
   {name="Vêtements", colour=5, scale=0.8, id=73, x = 1696.5310058594, y = 4828.109375, z = 42.063121795654},
   {name="Vêtements", colour=5, scale=0.8, id=73, x = -162.85632324219, y = -303.03753662109, z = 39.733276367188},
   {name="Vêtements", colour=5, scale=0.8, id=73, x= 72.531211853027, y= -1396.3240966797, z= 29.376146316528},
  ...
  --  {name="Ammunition", colour=9, scale=0.9, id=110, x=-3157.450, y=1079.633, z=20.692},
   ...
   {name="Station Service", colour=76, scale=0.7, id=361, x=2581.321, y=362.039, 108.468},
    -- Police Stations
   {name="Commisariat", colour=3, scale=1.2, id=60, x=425.130, y=-979.558, z=30.711},
   ...
   {name="Hôpital", colour=3, scale=1.2, id=61, x= 295.83, y= -1446.94, z= 29.97},
